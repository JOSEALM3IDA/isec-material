...
void geraVizinho(int* sol, int* viz, const int* dist, int M, int G) {
    int i, j, g1, g2;
    int sum, sump1, sump2;
    int p1 = -1, p2 = -1;
...
int simulatedAnnealing(int* sol, const int* dist, int M, int G, int nVizinhos, float tempMaxima, float tempMinima, float fatorAtualizacao) {
