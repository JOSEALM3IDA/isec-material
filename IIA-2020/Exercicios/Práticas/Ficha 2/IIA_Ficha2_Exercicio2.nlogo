...
to setup-patches
  ...
  ; 5% dos patches fica com a cor vermelha. os restantes a preto
  ask patches
  [
    ifelse random 100 < 5 [
      set pcolor red
...
to MoveFormigas
  ask formigas [
    (ifelse [pcolor] of patch-ahead 1 = red [rt 90]
	[pcolor] of patch-ahead 1 = blue [
      fd 1
      set nNinhoAzul nNinhoAzul + 1
      die
    ] [
        (ifelse random 100 < 90 [fd 1]
		random 100 < 5 [right 90]
		[left 90])
    ])
  ]
end
...
"" ""
PENS
"pen-0" 1.0 0 -13345367 true "" "plot count formigas"
"pen-1" 1.0 0 -1184463 true "" "plot count caracois"
