...
to MoveFormigas
  ask formigas [
    if any? caracois-on neighbors and nErva >= 10[
      let prey one-of caracois-on neighbors
      set energia energia + [energia] of prey
      ask prey [die]
      set nErva 0
    ]
...
to MoveCaracois2
  ask caracois[
    ...
    [ifelse [pcolor] of patch-right-and-ahead 90 1 = green [rt 90]
      [ifelse [pcolor] of patch-left-and-ahead 90 1 = green [lt 90]
      ;else
      [set energia energia - 1]
      ]
    ]
                ...
                [ifelse [pcolor] of patch-left-and-ahead 90 1 = red[
                    ...
                    [ifelse [pcolor] of patch-right-and-ahead 90 1 = red
                      ...
                      [ifelse random 100 < 90
                        [forward 1]
                        [ifelse random 100 < 50 [rt 90][lt 90]
                        ]
                      ]
                    ]
                ]
...
to Reproducao
  ask formigas [
    if energia > Energia_Reproducao and random 100 < reproducaoFormigas [
      set energia energia / 2
      let energiaMae energia
      hatch 1 [
        set energia EnergiaMae
        jump 5
      ]
    ]
  ]
  ...
  ask caracois [
    if energia > Energia_Reproducao and random 100 < reproducaoCaracois [
      set energia energia / 2
      let energiaMae energia
      hatch 1 [
        set energia EnergiaMae
