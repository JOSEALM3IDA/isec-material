...
to-report trilho-2-frente
  set perceptions perceptions + 1
  if [pcolor] of patch-ahead 1 = red or [pcolor] of patch-ahead 2 = red [
    ifelse any? patches with [pcolor = green] [
      if comerTudo? = false [report 1]
    ] [report 1]
  ]

    if ([pcolor] of patch-ahead 1 = green or [pcolor] of patch-ahead 2 = green)
    [
        report 1
    ]
...
to move-turtle-percecao
    ask turtle 0 [
    ifelse (trilho-frente = 1 or trilho-2-frente = 1) [
      forward 1
    ] [
      right 90
      ifelse (trilho-frente = 1 or trilho-2-frente = 1) [
